...
class addSubSubConceptIndividualAttrForm(forms.Form):
	...
	ind_for_attribute_name = forms.CharField(max_length = 30, label='экземпляр атрибута', required=False, widget = forms.HiddenInput())

class DeleteConceptForm(forms.Form):
	del_concept_name = forms.CharField(max_length = 30, label='класс', required=False, widget = forms.HiddenInput())

class DeleteOntologyForm(forms.Form):
	del_ontology_name = forms.CharField(max_length = 30, label='класс', required=False, widget = forms.HiddenInput())

class DeleteConceptIndividualForm(forms.Form):
	del_concept_ind_name = forms.CharField(max_length = 30, label='класс', required=False, widget = forms.HiddenInput())
	del_indc_name = forms.CharField(max_length = 30, label='экземпляр', required=False, widget = forms.HiddenInput())

class DeleteSubConceptIndividualForm(forms.Form):
	del_subconcept_ind_name = forms.CharField(max_length = 30, label='подкласс', required=False, widget = forms.HiddenInput())
	del_conc_ind_name = forms.CharField(max_length = 30, label='класс', required=False, widget = forms.HiddenInput())
	del_indsc_name = forms.CharField(max_length = 30, label='экземпляр', required=False, widget = forms.HiddenInput())

class DeleteSubSubConceptIndividualForm(forms.Form):
	del_subsubcon_ind_name = forms.CharField(max_length = 30, label='подподкласс', required=False, widget = forms.HiddenInput())
	del_subcon_ind_name = forms.CharField(max_length = 30, label='подкласс', required=False, widget = forms.HiddenInput())
	del_con_ind_name = forms.CharField(max_length = 30, label='класс', required=False, widget = forms.HiddenInput())
	del_indssc_name = forms.CharField(max_length = 30, label='экземпляр', required=False, widget = forms.HiddenInput())

class DeleteSubConceptForm(forms.Form):
	concept_name_for_del_sub = forms.CharField(max_length = 30, label='класс', required=False, widget = forms.HiddenInput())
	del_subconcept_name = forms.CharField(max_length = 30, label='подкласс', required=False, widget = forms.HiddenInput())

class DeleteSubSubConceptForm(forms.Form):
	concept_name_for_del_sub_sub = forms.CharField(max_length = 30, label='класс', required=False, widget = forms.HiddenInput())
	sub_concept_name_for_del_sub_sub = forms.CharField(max_length = 30, label='подкласс', required=False, widget = forms.HiddenInput())
	del_sub_sub_concept_name = forms.CharField(max_length = 30, label='подподкласс', required=False, widget = forms.HiddenInput())
...
class CreateOntologyForm(forms.Form):
	new_ontology_name = forms.CharField(max_length = 30, label='', required=False)
...
class ChoiseOntologyForm(forms.Form):
	def __init__(self, *args,**kwargs):
		...
		self.fields['ontologys'] =forms.ChoiceField(choices=ontology_choices, label='', required=False)
